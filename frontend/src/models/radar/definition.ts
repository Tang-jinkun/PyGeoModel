...
export const radarDefinition = {
  ...
  createDefaultRequest: (): RadarRequest => ({
    ...
    advanced: { use_curvature: true, curvature_coeff: 0.75, output_simplify_tolerance_m: 30, voxel_grid_size: 128, voxel_vertical_levels: 16, voxel_max_height_m: 3000, min_elevation_deg: -8, max_elevation_deg: 24, vertical_beam_width_deg: 32, visual_dome_mode: true, height_layers_m: [] },
