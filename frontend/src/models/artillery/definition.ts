...
export const artilleryDefinition = {
  ...
  spatialInput: "point-target",
  inputSlots: [terrainInputSlot],
  createDefaultRequest: (): ArtilleryRequest => ({
    dem_id: "",
    battery: { lon: 79.80513693057287, lat: 31.4827708959419, height_m: 0, altitude_mode: "agl" }, target: { lon: null, lat: null, target_height_m: 0 },
  ...
  metrics: [
    { key: "theoretical_area_m2", label: "Theoretical area", format: "area" }, { key: "reachable_area_m2", label: "Reachable area", format: "area" }, { key: "terrain_masked_area_m2", label: "Terrain masked area", format: "area" }, { key: "terrain_masked_ratio", label: "Terrain masked ratio", format: "percent" }, { key: "lethal_area_m2", label: "Lethal area", format: "area" }, { key: "effective_area_m2", label: "Effective area", format: "area" }, { key: "min_range_m", label: "Minimum range", format: "distance" }, { key: "max_range_m", label: "Maximum range", format: "distance" }, { key: "effective_traverse_deg", label: "Effective traverse", format: "number" }, { key: "lethal_radius_m", label: "Lethal radius", format: "distance" }, { key: "effective_radius_m", label: "Effective radius", format: "distance" }, { key: "sample_point_count", label: "Sample points", format: "number" }, { key: "reachable_sample_count", label: "Reachable samples", format: "number" }, { key: "masked_sample_count", label: "Masked samples", format: "number" }, { key: "min_clearance_m", label: "Minimum clearance", format: "distance" }, { key: "mean_clearance_m", label: "Mean clearance", format: "distance" }, { key: "battery_ground_elevation_m", label: "Battery ground elevation", format: "distance" }, { key: "battery_altitude_m", label: "Battery altitude", format: "distance" }, { key: "target_reachable", label: "Target reachable", format: "text" }, { key: "target_range_m", label: "Target range", format: "distance" }, { key: "target_min_clearance_m", label: "Target minimum clearance", format: "distance" }, { key: "target_masking_distance_m", label: "Target masking distance", format: "distance" }, { key: "target_trajectory_peak_m", label: "Target trajectory peak", format: "distance" }, { key: "target_time_of_flight_s", label: "Target time of flight", format: "duration" }
  ],
  outputLayers: [
