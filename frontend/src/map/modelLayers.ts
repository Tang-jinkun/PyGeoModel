...
import type { GeoJSONSource, LayerSpecification, Map as MapInstance } from "./mapEngineTypes";
...
const layerRegistry = new WeakMap<MapInstance, Map<string, RegisteredLayer>>();
...
export function removeTaskLayers(map: MapInstance, modelId: ModelId, taskId: string) {
...
function registryFor(map: MapInstance): Map<string, RegisteredLayer> {
